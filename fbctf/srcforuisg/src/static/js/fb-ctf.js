...
function activateTeams() {
  ...
  $teamgrid.on('click', 'a', function(event) {
    ...
    Modal.loadPopup('p=team&modal=team', 'team', function() {
      ...
      $('[data-modal=scoreboards]').on('click', function() {
        Modal.load('p=scoreboard&modal=scoreboard&st=1', 'scoreboard');
      });
...
(function(FB_CTF) {
  ...
  FB_CTF.gameboard = (function() {
    ...
    function init() {
      ...
      $gameboard.find('[data-modal=scoreboards]').on('click', function() {
        Modal.load('p=scoreboard&modal=scoreboard&st=1', 'scoreboard');
      });
