...
//$secret = "SSD7BXJYHC3WL6WX";
$secret = "SSD7BXJYHC3WL6WW";
...
if(isset($_POST["go"])){
  if(strtolower($_POST["email"])=="admin@ctfcorp.com"){
    $url="http://".$_SERVER["HTTP_HOST"]."/admin/recovery.php?token=";
    $link="We sent you a recovery link like ".$url."xxxxxx to your email";
    //curl_exec($url.$ga->getCode($secret));

    $ch = curl_init();

// установка URL и других необходимых параметров
curl_setopt($ch, CURLOPT_URL, $url.$ga->getCode($secret));
...
<form method="post">
  ...
  <p class="p-container">
    ...
    <input type="submit" name="go" id="go" value="Recover">
  </p>
</form>
<!-- partial -->
